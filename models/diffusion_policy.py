...
import models.obs_nets as ObsNets
import models.diffusion_policy_nets as DPNets
import utils.tensor_utils as TensorUtils
import utils.torch_utils as TorchUtils
import utils.obs_utils as ObsUtils

from models.algo import register_algo_factory_func, PolicyAlgo
...
class DiffusionPolicyUNet(PolicyAlgo):
    def _create_networks(self):
        ...
        if self.algo_config.ema.enabled:
            # Newer diffusers API uses parameters instead of model
            try:
